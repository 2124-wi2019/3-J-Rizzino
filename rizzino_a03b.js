...
const lastName = `Rizzino`;
const villainFirstName = `Commander`;
const villainLastName = `Red`;
const companyName = `Red Ribbon Army, INC`;
let annualSalary = 1000000;
let laughString = `Ha \n`;
let age = 30;
let weight = 134.5;
let counterStartValue = 7;
let indexOfFirst = lastName.indexOf('z')
...
${lastName.indexOf('R')} ${lastName.indexOf('z')} ${lastName.indexOf('z',(indexOfFirst + 1))}
